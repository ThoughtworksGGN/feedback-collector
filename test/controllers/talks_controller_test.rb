...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { conference_id: @talk.conference_id, description: @talk.description, end: @talk.end, name: @talk.name, presenter: @talk.presenter, start: @talk.start }
    end
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { conference_id: @talk.conference_id, description: @talk.description, end: @talk.end, name: @talk.name, presenter: @talk.presenter, start: @talk.start }
    assert_redirected_to talk_path(assigns(:talk))
  end
